//*Dependencies
//*ICS library source: https://github.com/nwcell/ics.js
...
// source: https://stackoverflow.com/questions/40512120/convert-html-table-as-a-string-into-js-objects-array
// Function takes in HTML text (string) and outputs a js array
function HTMLtoArray(html){
	...
	console.log(obj) //to remove
	return obj
}

// Exports to ics file
function exportToICS(){
	// Add params when exporting
	var cal = ics();
